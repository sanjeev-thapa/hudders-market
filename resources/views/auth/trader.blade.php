...
<div class="container">
    <form method="post" class="form auth-form mx-auto">
        ...
        <div class="form-group mt-4">
            ...
            <input class="form-control py-4 @error('shop_name') is-invalid @else border-dark @enderror" id="shop_name"
                name="shop_name" type="text" placeholder="Shop Name" value="{{ old('shop_name') }}">
            @error('shop_name') <div class="invalid-feedback"> {{ $message }} </div> @enderror
        </div>

        <div class="form-group mt-4">
            <label class="mb-0" for="product_type">Product Type</label>
            <input class="form-control py-4 @error('product_type') is-invalid @else border-dark @enderror"
