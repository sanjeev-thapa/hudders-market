            ...
            <div class="input-group ml-3 ml-lg-5">
                ...
                <div class="input-group-append">
                    <button class="btn btn-primary prepend-text">
                        <img class="text-white" width="20" src="assets/images/search.svg" alt="Search">
                    </button>
                </div>
            </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 mt-5">
                ...
                <div class="row">
                    <div class="form-group col">
                        <select class="form-control border-text" id="first">
                ...
                <hr>
                <p class="text-dark text-left">Category</p>
                <div class="row">
                    <div class="form-group col">
                        <select class="form-control border-text" id="first">
                            <option>Lorem Ipsum</option>
            ...
            <div class="col">
                ...
                <p class="mt-3">16 items found for "Product Title"</p>
                </div>
